...
- satisfy clippy in test targets

## [0.1.2](https://github.com/anjaneyasivan/ammini/compare/v0.1.1...v0.1.2) - 2026-09-26
...
- seekbar and cache-shade glitches when seeking with arrow keys
